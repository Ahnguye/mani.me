...
export default class SplashPage extends Component {
  render() {
    return (
      <div>
        <img className="banner" src="https://d1raprm0ezfai1.cloudfront.net/Website+images+used/Photo+Fillers/_shutterstock_658353277.jpg" />
        ...
        Three ways to be perfectly polished

        <div className="row icons">
          <div className="col-12 col-md-3 icon-container">
            <img className="icon" src="https://d1raprm0ezfai1.cloudfront.net/Website+images+used/Photo+Fillers/shutterstock_514409545.jpg" />
          </div>
          <div className="col-12 col-md-3 icon-container">
            <img className="icon" src="https://d1raprm0ezfai1.cloudfront.net/Website+images+used/Photo+Fillers/brigitte-tohm-388989.jpg" />
          </div>
          <div className="col-12 col-md-3 icon-container">
            <img className="icon" src="https://d1raprm0ezfai1.cloudfront.net/Website+images+used/Photo+Fillers/_shutterstock_735672685.jpg" />
          </div>
        </div>
